...
const Dashboard = () => {
    ...
    return (
      <div className="space-y-4">
        {recentWorkouts.map((workout) => (
          <div key={workout.id} className="flex items-center gap-4 p-4 bg-gray-800 text-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
  ...
  return (
    <div className="max-w-7xl mx-auto p-8 space-y-8 bg-gray-900 text-white">
      {/* Header Section */}
      <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-300 text-sm">Log your latest fitness activity</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-300 text-sm">{stats.workoutsThisWeek} workouts logged</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-300 text-sm">{stats.activeGoals} goals in progress</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-300 text-sm">Connect with other fitness enthusiasts</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent Workouts */}
        <div className="lg:col-span-2 bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          <div className="p-6 flex justify-between items-center border-b">
            <h2 className="text-xl font-bold">Recent Workouts</h2>
            <button onClick={() => navigate('/workouts')} className="text-green-500 hover:text-green-600 transition-colors">View All</button>
          </div>
          <div className="p-6">{renderWorkoutList()}</div>
        </div>

        {/* Quick Stats */}
        <div className="bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-shadow">
